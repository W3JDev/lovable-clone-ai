...
<body>
  ...
  return (
    <div className="h-full flex flex-col glass-ultra border-l border-white/10">
      ...
      <div className="p-6 border-b border-white/10 bg-gradient-to-r from-white/5 to-white/10">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <span className="px-3 py-1 bg-green-400/20 rounded-full text-xs text-green-300 font-medium">
              Ultra HD
            </span>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              disabled={isLoading}
              className="p-2 glass-ultra rounded-xl hover:bg-white/10 transition-all duration-300 group"
              title="Refresh preview"
            >
              <ArrowPathIcon className={`w-5 h-5 text-gray-300 group-hover:text-white transition-colors ${isLoading ? 'animate-spin' : ''}`} />
            </button>
            ...
            <button
              ...
              title="Share project"
            >
              <ShareIcon className="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" />
            </button>
        ...
        {/* Device Toggle */}
        <div className="flex items-center space-x-2">
          <div className="glass-ultra rounded-xl p-1 flex">
            <button
          ...
          >
            <ArrowsPointingOutIcon className="w-4 h-4 text-gray-300 group-hover:text-white transition-colors" />
          </button>
        </div>
      </div>

      {/* Preview Content */}
      <div className="flex-1 relative bg-gradient-to-br from-gray-100 to-gray-200 p-6">
        {error ? (
          ...
          <div className="h-full relative">
            ...
            <div className={`h-full ${
              ...
              <div className={`h-full ${
                viewMode === 'mobile' 
                  ? 'rounded-3xl border-8 border-gray-800 shadow-2xl bg-black p-1' 
                  : 'rounded-2xl shadow-2xl overflow-hidden border border-gray-300'
              }`}>
                <iframe
                  ref={iframeRef}
